...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	// to be posted from:  
	$authHosts = array("iconagility.com", "staging.iconagility.com", "myraharriscoaching.com");
	...
	$inputName			=	clean_input($_POST['inputName']);
	$inputEmail			=	clean_input($_POST['inputEmail']);
	$inputPhone			=	clean_input($_POST['inputPhone']);
	$inputComments	=	clean_input($_POST['inputComments']);
	...
	if (empty($inputName)) {
		...
		if ($warning == "") {
			...
			$mail->setFrom('webcontact@iconagility.com', 'MH Coaching Website');
			$mail->addReplyTo('webcontact@iconagility.com', 'MH Coaching Website');
			$mail->addAddress('myraharris1962@gmail.com', 'MH Coaching');
			//$mail->addAddress('scott.lix@iconagility.com', 'Icon Website');
			$mail->Subject = 'MH Coaching Website Contact';
...
?>
						...
						<div class="alert alert-success">
							<strong>Thank you!</strong> Your e-mail has been sent. Please allow some time for us to address your request.
						</div>
